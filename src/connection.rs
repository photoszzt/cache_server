...
impl Connection {
    ...
    pub fn new(socket: TcpStream) -> Connection {
        Connection {
            ...
            // 2MB read buffer to start.
            buffer: BytesMut::with_capacity(2 * 1024 * 1024),
        }
    }
    ...
    fn parse_frame(&mut self) -> crate::Result<Option<Frame>> {
        ...
        // received.
        match Frame::check_with_pos(&self.buffer, 0) {
            Ok(_) => {
                ...
                let frame = Frame::parse_with_pos(&mut self.buffer, 0)?;
